...
public class PredicateExample {
    public static void main(String[] args) {
        ...
        palavras.stream()
                .filter(maisDeCincoCaracteres)//Aqui estamos utilizando o Predicate acima
        ...
        //ou
        palavras.stream()
                .filter(p -> p.length() >5)//Aqui estamos passando o Predicate dentro do filter da stream e o resultado será o mesmo
                .forEach(System.out::println);
    }
}
